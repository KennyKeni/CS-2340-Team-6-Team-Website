    ...
    >
      ...
      <div className="mt-10 grid gap-8 lg:grid-cols-[minmax(0,1.3fr)_minmax(0,1fr)]">
        <Link to={`/projects/${project.slug}`} className="group">
          <article className="flex flex-col gap-6 rounded-3xl border border-border/70 bg-card p-8 shadow-sm transition-all hover:border-primary/60 hover:shadow-lg cursor-pointer">
          ...
          <div className="flex flex-wrap gap-3">
            <a
              ...
              className="relative z-10 inline-flex items-center gap-2 rounded-full border border-border/70 bg-background px-4 py-2 text-sm font-medium text-foreground transition hover:border-primary/60 hover:text-primary"
            >
              GitHub Repository
            ...
            {project.liveSite && (
              <a
                ...
                onClick={(e) => e.stopPropagation()}
                className="relative z-10 inline-flex items-center gap-2 rounded-full border border-primary/40 bg-primary/10 px-4 py-2 text-sm font-medium text-primary transition hover:bg-primary/20"
              >
                Project website
                <ArrowUpRight className="size-4" />
              </a>
            )}
            <div className="relative z-10 inline-flex items-center gap-2 rounded-full border-2 border-primary bg-primary px-4 py-2 text-sm font-semibold text-primary-foreground transition group-hover:bg-primary/90">
